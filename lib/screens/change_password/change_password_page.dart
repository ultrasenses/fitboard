...
import 'package:ultrasenses_fitboard/screens/change_password/bloc/change_password_bloc.dart';
import 'package:ultrasenses_fitboard/screens/common_widgets/fitness_button.dart';
import 'package:ultrasenses_fitboard/screens/common_widgets/fitness_loading.dart';
import 'package:ultrasenses_fitboard/screens/common_widgets/settings_container.dart';
import 'package:ultrasenses_fitboard/screens/common_widgets/settings_textfield.dart';
    ...
    return BlocProvider<ChangePasswordBloc>(
      ...
      child: BlocConsumer<ChangePasswordBloc, ChangePasswordState>(
        ...
        builder: (context, state) {
          if (state is ChangePasswordProgress) return Stack(children: [_editAccountContent(context), const FitnessLoading()]);
